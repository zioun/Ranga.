        ...
        <div className="bg-[#E5E2DB] p-2">
          ...
          <div className="flex justify-center text-center">
            <div className="bg-[#ffffff] rounded-md p-5 md:p-10 my-[100px] max-w-[9000px] shadow">
              ...
              Explore our latest additions for cartoon drawing! From sketch pads to vibrant markers, find everything you need to create your own colorful characters and bring them to life on the page.
              </p>
