        ...
        <div className="bg-[#E5E2DB] p-2">
          ...
          <div className="flex justify-center text-center">
            <div className="bg-[#ffffff] rounded-md p-5 md:p-10 my-[100px] max-w-[9000px] shadow">
              ...
              Introducing our latest essentials for watercolor painting! Dive into a world of vibrant hues and delicate washes with our selection of high-quality paints, brushes, and papers. Let your creativity flow with our newest supplies.
              </p>
